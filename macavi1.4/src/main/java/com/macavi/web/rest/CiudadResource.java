...
/**
 * REST controller for managing {@link com.macavi.domain.Ciudad}.
 */
@RestController
@RequestMapping("/api")
public class CiudadResource {
    ...
    public ResponseEntity<List<CiudadDTO>> getAllCiudads(
        ...
        Page<CiudadDTO> page;
        if (eagerload) {
            page = ciudadService.findAllWithEagerRelationships(pageable);
        } else {
            page = ciudadService.findAll(pageable);
        }
