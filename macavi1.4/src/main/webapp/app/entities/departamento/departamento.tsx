  ...
  return (
    <div>
      <h2 id="departamento-heading" data-cy="DepartamentoHeading">
        <Translate contentKey="macaviApp.departamento.home.title">Departamentos</Translate>
        <div className="d-flex justify-content-end">
          <Button className="me-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="macaviApp.departamento.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to="/departamento/new" className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="macaviApp.departamento.home.createLabel">Create new Departamento</Translate>
          </Link>
        </div>
      </h2>
        ...
        {departamentoList && departamentoList.length > 0 ? (
            ...
            <thead>
              <tr>
                <th className="hand" onClick={sort('id')}>
                  <Translate contentKey="macaviApp.departamento.id">ID</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                ...
                <th>
                  <Translate contentKey="macaviApp.departamento.pais">Pais</Translate> <FontAwesomeIcon icon="sort" />
                </th>
                <th />
              </tr>
            </thead>
            <tbody>
              {departamentoList.map((departamento, i) => (
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td>{departamento.pais ? <Link to={`/pais/${departamento.pais.id}`}>{departamento.pais.nombrePais}</Link> : ''}</td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="macaviApp.departamento.home.notFound">No Departamentos found</Translate>
            </div>
          )
        )}
      </div>
