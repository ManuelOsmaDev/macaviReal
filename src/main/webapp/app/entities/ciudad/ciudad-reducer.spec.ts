...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './ciudad.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CIUDAD_LIST actions', async () => {
    ...
    it('dispatches FETCH_CIUDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CIUDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CIUDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CIUDAD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CIUDAD actions', async () => {
      const expectedActions = [
        {
