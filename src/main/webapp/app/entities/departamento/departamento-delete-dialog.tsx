...
export const DepartamentoDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="macaviApp.departamento.delete.question">
        <Translate contentKey="macaviApp.departamento.delete.question" interpolate={{ id: departamentoEntity.id }}>
      ...
      <ModalFooter>
        ...
        <Button id="ejemplo-confirm-delete-departamento" data-cy="entityConfirmDeleteButton" color="danger" onClick={confirmDelete}>
