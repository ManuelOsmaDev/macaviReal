...
export const ClienteUpdate = (props: RouteComponentProps<{ id: string }>) => {
  ...
  const ciudads = useAppSelector(state => state.ciudad.entities);
  ...
  const saveEntity = values => {
    const entity = {
      ...clienteEntity,
      ...values,
      locate: ciudads.find(it => it.id.toString() === values.locate.toString()),
        ...
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('macaviApp.cliente.razonSocial')}
